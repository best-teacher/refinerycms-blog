...
module Refinery
  module StudentBlog
    describe PostsHelper do
      describe "#student_blog_archive_widget" do
        let(:html) { helper.student_blog_archive_widget(dates) }
        let(:links) { Capybara.string(html).find("#student_blog_archive_widget ul") }
