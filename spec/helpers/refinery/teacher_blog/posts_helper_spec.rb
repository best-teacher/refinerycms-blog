...
module Refinery
  module TeacherBlog
    describe PostsHelper do
      describe "#teacher_blog_archive_widget" do
        let(:html) { helper.teacher_blog_archive_widget(dates) }
        let(:links) { Capybara.string(html).find("#teacher_blog_archive_widget ul") }
