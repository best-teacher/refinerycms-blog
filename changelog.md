...
## 1.6.1 [21 June 2011]
* Tagging URL strategy updated for reliability /teacher_blog/posts/tagged/ID-name-parameterized [joemsak](https://github.com/joemsak)
...
* Customize the URL of your teacher_blog post [wikyd](https://github.com/wikyd)
...
* [See full list](https://github.com/resolve/refinerycms-teacher_blog/compare/1.3...1.4)

## 1.3 [03 March 2011]

* Moved to EngineInstaller [parndt](https://github.com/parndt)
* Off Rails 2 support [parndt](https://github.com/parndt)
* [See full list](https://github.com/resolve/refinerycms-teacher_blog/compare/1.2...1.3)
...
* Removed ajax teacher_blog post navigation [joemsak](https://github.com/joemsak)
...
* [See full list](https://github.com/resolve/refinerycms-teacher_blog/compare/1.1...1.2)
...
* Archives
* Categories
* [See full list](https://github.com/resolve/refinerycms-teacher_blog/compare/1.0...1.1)