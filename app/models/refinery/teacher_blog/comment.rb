module Refinery
  module TeacherBlog
    class Comment < ActiveRecord::Base
      ...
      belongs_to :post, :foreign_key => 'teacher_blog_post_id'
      ...
      self.per_page = Refinery::TeacherBlog.comments_per_page
      ...
      def self.toggle!
        currently = Refinery::Setting.find_or_set(:comments_allowed, true, {
          :scoping => 'teacher_blog'
        })
        Refinery::Setting.set(:comments_allowed, {:value => !currently, :scoping => 'teacher_blog'})
      end
      ...
      module Moderation
        class << self
          ...
          def toggle!
            new_value = {
              :value => !TeacherBlog::Comment::Moderation.enabled?,
              :scoping => 'teacher_blog',
              :restricted => false
            }
