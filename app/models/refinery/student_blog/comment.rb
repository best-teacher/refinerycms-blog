module Refinery
  module StudentBlog
    class Comment < ActiveRecord::Base
      ...
      belongs_to :post, :foreign_key => 'student_blog_post_id'
      ...
      self.per_page = Refinery::StudentBlog.comments_per_page
      ...
      def self.toggle!
        currently = Refinery::Setting.find_or_set(:comments_allowed, true, {
          :scoping => 'student_blog'
        })
        Refinery::Setting.set(:comments_allowed, {:value => !currently, :scoping => 'student_blog'})
      end
      ...
      module Moderation
        class << self
          ...
          def toggle!
            new_value = {
              :value => !StudentBlog::Comment::Moderation.enabled?,
              :scoping => 'student_blog',
              :restricted => false
            }
